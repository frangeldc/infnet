...
//		Endereco enderecoFilipe = new Endereco();
//		enderecoFilipe.setBairro("bairro");
//		enderecoFilipe.setCep("cep");
//		enderecoFilipe.setComplemento("comp");
//		enderecoFilipe.setLocalidade("loc");
//		enderecoFilipe.setLogradouro("log");
//		enderecoFilipe.setUf("uf");
//		
//		Usuario filipe = new Usuario();
//		filipe.setEmail("filipe@al.infnet.edu.br");
//		filipe.setEndereco(enderecoFilipe);
//		filipe.setNome("");
//		filipe.setRoles(null);
//		filipe.setSenha(null);
//		
//		usuarioService.incluir(filipe);
